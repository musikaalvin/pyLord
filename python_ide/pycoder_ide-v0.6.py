...
class PythonInterpreterPanel(tk.Frame):
    def __init__(self, parent):
        ...
        self.text = scrolledtext.ScrolledText(self, font=("Courier", 10))
...
class FullVSIDE(tk.Tk):
    ...
    def create_main_panes(self):
        ...
        if Terminal:
            ...
            self.terminal_tab_text = tk.Text(terminal_frame, height=10, bg="black", fg="white")
        ...
        self.debugger_text = tk.Text(debugger_frame, height=10, bg="black", fg="red")
